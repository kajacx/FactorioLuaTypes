...
---@field source_positions [object Object]
---@field source_surface LuaSurface
---@field tick uint Tick the event was generated.
...
---@field name defines.events Identifier of the event
---@field positions [object Object] The chunks deleted.
---@field surface_index uint
---@field tick uint Tick the event was generated.
...
---@field entities [object Object] The entities selected.
...
---@field tick uint Tick the event was generated.
---@field tiles [object Object] The tiles selected.
...
---@field tiles [object Object] The position data.
...
---@field area BoundingBox The area selected.
---@field item string The item used to select the area.
---@field mapping [object Object] The blueprint entity index to source entity mapping. Note: if any mod changes the blueprint this will be incorrect.
---@field name defines.events Identifier of the event
---@field player_index uint The player doing the selection.
---@field surface LuaSurface The surface selected.
---@field tick uint Tick the event was generated.
...
---@field corpses [object Object] The corpses created by the entity dying if any.
---@field damage_type LuaDamagePrototype The damage type if any.
---@field force LuaForce The force that did the killing if any.
...
---@field name defines.events Identifier of the event
---@field positions [object Object] The chunks to be deleted.
---@field surface_index uint
---@field tick uint Tick the event was generated.
...
---@field name defines.events Identifier of the event
---@field path [object Object] The actual path that the pathfinder has determined. `nil` if pathfinding failed.
---@field tick uint Tick the event was generated.
...
---@field tick uint Tick the event was generated.
---@field tiles [object Object] The tiles that were changed.
